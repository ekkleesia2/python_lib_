...
module RbConfig
  RUBY_VERSION == "2.1.1" or
    raise "ruby lib version (2.1.1) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "1"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "76"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/var/lib/openshift/535c1892e0b8cd5f9a00021d/app-root/data")
  ...
  CONFIG["configure_args"] = " '--prefix=/var/lib/openshift/535c1892e0b8cd5f9a00021d/app-root/data/'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/var/lib/openshift/535c1892e0b8cd5f9a00021d/app-root/data"
  ...
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.1.1"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = ""
  CONFIG["LIBS"] = "-lpthread -lrt -lgmp -ldl -lcrypt -lm "
  CONFIG["ECHO_T"] = ""
  CONFIG["ECHO_N"] = "-n"
  CONFIG["ECHO_C"] = ""
  CONFIG["DEFS"] = ""
